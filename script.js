...
//     // Save tasks to localStorage whenever a task is added, completed, or deleted
...
//         if (event.target.classList.contains('completeBtn') || event.target.classList.contains('deleteBtn')) {
//             saveTasksToLocalStorage();
//         }
//     });
// });
